...
function Fixture() {
  ...
  return <main className="button-standard">
    ...
    <section><h2>其他按钮</h2><div className="standard-examples">
      <div><h3>行内 · 24px</h3><div className="standard-controls"><button className="sidebar-row-icon-button" aria-label="添加项目"><Plus className="icon-sm"/></button><button className="sidebar-row-icon-button" aria-label="项目设置"><Settings2 className="icon-sm"/></button><button className="workspace-tool-tab-close" aria-label="关闭工具标签"><X className="icon-xs"/></button></div></div>
