...
const room = { id: "room", name: "项目协作", kind: query.has("dm") ? "dm" : "channel", created_by: "human", created_at,
  members: (query.has("dm") ? agents.slice(0, 1) : agents).map(a => ({ room_id: "room", member_type: "agent", member_id: a.id, joined_at: created_at })) };
