...
export const iconArtwork = {
  ...
  Plus: [plus],
  Project: [
    path("M7.3 11.4 4.7 10.3C3.2 9.7 2.9 8.6 3.5 7.7 4.1 6.7 5.2 6.6 6.5 7.2L10.3 9l2.3-2.7c1-1.2 2.5-1.2 3.3-.2 1 1.3-.5 2.7-.2 4.1.3 1.2 1.9 2.1 2.2 4.1l2.7.7-1.5 6-3.4-.7-6.5-1.5c-2.4-.6-3.4-2-3-4.1"),
    path("M7.2 14.6c-1.1 0-1.5-1.2-.7-2.4 1-1.5 3.3-1.9 4.9-.6 1.2 1 1.7 2.9.9 3.5-.4.3-.9.2-1.5 0M17.9 14.3l-.8 3.3"),
  ],
