...
describe("collapsed sidebar hover drawer", () => {
  ...
  it.each([
    ...
    ["slow left-side swipe", 16, 80, 400, 650, false],
    ["slow middle swipe", 150, 80, 400, 650, false],
    ["slow right-side swipe", 280, 70, 400, 650, false],
    ["light middle-right swipe", 250, 34, 400, 650, false],
    ["light right-side swipe", 300, 32, 400, 650, false],
    ["light near-edge swipe", 350, 26, 400, 650, false],
    ["slow near-edge swipe", 340, 38, 400, 650, false],
    ...
    ["short swipe followed by a hold", 100, 80, 150, 500, false],
    ["long swipe followed by a hold", 100, 180, 250, 500, true],
