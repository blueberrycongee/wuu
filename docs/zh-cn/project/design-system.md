...
Wuu 的界面以长时间阅读与高频操作为中心：中性表面承载内容，朱红只承担品牌强调，状态色传达状态。优先用位置、留白、字号和字重建立层级，再按需要加入边界与阴影。
...
![Wuu 浅色设计系统：表面、文字、边界、品牌、交互与状态颜色](../../en/assets/design-system/colour-light.png)
...
| 品牌与交互 | `--wuu-accent`、`--wuu-accent-press`、`--interaction-accent` | 朱红用于品牌强调；滑块使用独立强调角色，导航与阅读面保持中性 |
