...
func TestInterruptSessionRefusesForeignNamedAgentSession(t *testing.T) {
	...
	_, err = server.channelService.CreateTaskHuman(context.Background(), channels.TaskCreateParams{
	...
	sessionRef := channels.NamedAgentConversationRef(agentRuntimeFromNamed(owner.Agent))
